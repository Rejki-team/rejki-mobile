...
mixin _$WorkerListingState {
 ...
 List<WorkerModel> get workers; bool get isLoading; bool get isFailure; String? get errorMessage; String get jobCountDisplayText; String get locationDisplayText; String? get searchQuery; int get distanceKm; bool get isDistanceFilterApplied; WorkerSortOption? get appliedSortOption; bool get isSortFilterApplied;
...
@useResult
$Res call({
 List<WorkerModel> workers, bool isLoading, bool isFailure, String? errorMessage, String jobCountDisplayText, String locationDisplayText, String? searchQuery, int distanceKm, bool isDistanceFilterApplied, WorkerSortOption? appliedSortOption, bool isSortFilterApplied
});
...
/// Create a copy of WorkerListingState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? workers = null,Object? isLoading = null,Object? isFailure = null,Object? errorMessage = freezed,Object? jobCountDisplayText = null,Object? locationDisplayText = null,Object? searchQuery = freezed,Object? distanceKm = null,Object? isDistanceFilterApplied = null,Object? appliedSortOption = freezed,Object? isSortFilterApplied = null,}) {
...
switch (_that) {
case _WorkerListingState() when $default != null:
return $default(_that.workers,_that.isLoading,_that.isFailure,_that.errorMessage,_that.jobCountDisplayText,_that.locationDisplayText,_that.searchQuery,_that.distanceKm,_that.isDistanceFilterApplied,_that.appliedSortOption,_that.isSortFilterApplied);case _:
  return orElse();
...
class _WorkerListingState implements WorkerListingState {
  const _WorkerListingState({final  List<WorkerModel> workers = const [], this.isLoading = false, this.isFailure = false, this.errorMessage, this.jobCountDisplayText = 'Memuat...', this.locationDisplayText = 'Radius 2 km', this.searchQuery, this.distanceKm = 2, this.isDistanceFilterApplied = false, this.appliedSortOption, this.isSortFilterApplied = false}): _workers = workers;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_workers),isLoading,isFailure,errorMessage,jobCountDisplayText,locationDisplayText,searchQuery,distanceKm,isDistanceFilterApplied,appliedSortOption,isSortFilterApplied);
