...
part of 'create_worker_ad_state.dart';
...
$CreateWorkerAdStateCopyWith<CreateWorkerAdState> get copyWith => _$CreateWorkerAdStateCopyWithImpl<CreateWorkerAdState>(this as CreateWorkerAdState, _$identity);
...
/// @nodoc
abstract mixin class $CreateWorkerAdStateCopyWith<$Res>  {
...
/// @nodoc
class _$CreateWorkerAdStateCopyWithImpl<$Res>
    implements $CreateWorkerAdStateCopyWith<$Res> {
  _$CreateWorkerAdStateCopyWithImpl(this._self, this._then);

  final CreateWorkerAdState _self;
  final $Res Function(CreateWorkerAdState) _then;
...
as String,minimumWage: null == minimumWage ? _self.minimumWage : minimumWage // ignore: cast_nullable_to_non_nullable
...
as List<File>,domicileAddress: null == domicileAddress ? _self.domicileAddress : domicileAddress // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [CreateWorkerAdState].
extension CreateWorkerAdStatePatterns on CreateWorkerAdState {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CreateWorkerAdState value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _CreateWorkerAdState value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _CreateWorkerAdState value)?  $default,){
final _that = this;
switch (_that) {
case _CreateWorkerAdState() when $default != null:
return $default(_that);case _:
...
@override@JsonKey() final  String minimumWage;
@override@JsonKey() final  String isNegotiable;
@override@JsonKey() final  String phoneNumber;
@override@JsonKey() final  String experience;
 final  List<File> _photos;
@override@JsonKey() List<File> get photos {
  if (_photos is EqualUnmodifiableListView) return _photos;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_photos);
}

@override@JsonKey() final  String domicileAddress;
...
@pragma('vm:prefer-inline')
_$CreateWorkerAdStateCopyWith<_CreateWorkerAdState> get copyWith => __$CreateWorkerAdStateCopyWithImpl<_CreateWorkerAdState>(this, _$identity);
...
/// @nodoc
abstract mixin class _$CreateWorkerAdStateCopyWith<$Res> implements $CreateWorkerAdStateCopyWith<$Res> {
...
/// @nodoc
class __$CreateWorkerAdStateCopyWithImpl<$Res>
    implements _$CreateWorkerAdStateCopyWith<$Res> {
  __$CreateWorkerAdStateCopyWithImpl(this._self, this._then);

  final _CreateWorkerAdState _self;
  final $Res Function(_CreateWorkerAdState) _then;
