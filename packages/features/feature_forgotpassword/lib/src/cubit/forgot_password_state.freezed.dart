...
/// Input email
 EmailInput get email;/// Status form
 ForgotPasswordStatus get status;/// Error message jika gagal
...
@override
int get hashCode => Object.hash(runtimeType,email,status,errorMessage,successMessage);

@override
String toString() {
  return 'ForgotPasswordState(email: $email, status: $status, errorMessage: $errorMessage, successMessage: $successMessage)';
}
...
@useResult
$Res call({
 EmailInput email, ForgotPasswordStatus status, String? errorMessage, String? successMessage
});
...
/// Create a copy of ForgotPasswordState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? email = null,Object? status = null,Object? errorMessage = freezed,Object? successMessage = freezed,}) {
  return _then(_self.copyWith(
email: null == email ? _self.email : email // ignore: cast_nullable_to_non_nullable
as EmailInput,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( EmailInput email,  ForgotPasswordStatus status,  String? errorMessage,  String? successMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ForgotPasswordState() when $default != null:
return $default(_that.email,_that.status,_that.errorMessage,_that.successMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( EmailInput email,  ForgotPasswordStatus status,  String? errorMessage,  String? successMessage)  $default,) {final _that = this;
switch (_that) {
case _ForgotPasswordState():
return $default(_that.email,_that.status,_that.errorMessage,_that.successMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( EmailInput email,  ForgotPasswordStatus status,  String? errorMessage,  String? successMessage)?  $default,) {final _that = this;
switch (_that) {
case _ForgotPasswordState() when $default != null:
return $default(_that.email,_that.status,_that.errorMessage,_that.successMessage);case _:
  return null;
...
class _ForgotPasswordState extends ForgotPasswordState {
  const _ForgotPasswordState({this.email = const EmailInput.pure(), this.status = ForgotPasswordStatus.initial, this.errorMessage, this.successMessage}): super._();
...
/// Create a copy of ForgotPasswordState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? email = null,Object? status = null,Object? errorMessage = freezed,Object? successMessage = freezed,}) {
