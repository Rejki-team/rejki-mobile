...
///
/// Bottom sheet for setting the distance/radius filter (0–2 KM).
///
/// ## Applied vs Default Visual
/// - [isInitiallyApplied] = false (default): slider renders with neutral track
///   color and label text shows "Belum diterapkan". Thumb sits at [initialDistance]
///   (default 2 KM = max radius) without the active blue color.
/// - [isInitiallyApplied] = true: slider track is fully active blue and a
///   "Reset" link appears in the header.
///
/// This distinction lets the page show that the API already uses location-based
/// distance while the user has not yet explicitly chosen a radius.
class DistanceFilterBottomSheet extends StatefulWidget {
  /// Initial distance value in KM (0–2, default 2 = max / "not applied")
  ...
  static Future<void> show(BuildContext context) async {
    ...
    await showModalBottomSheet<void>(
      ...
      builder: (sheetContext) => DistanceFilterBottomSheet(
...
class _DistanceFilterBottomSheetState extends State<DistanceFilterBottomSheet> {
  ...
  ///
  /// If true, we show the active color regardless of [widget.isInitiallyApplied].
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Expanded(
              child: Text(
                'Silakan atur jarak lokasi untuk menampilkan daftar pekerjaan sesuai radius yang diinginkan.',
  ...
  Widget _buildSliderSection() {
    ...
    return Column(
      children: [
        ...
        // Slider — range 0–2 KM with 0.5 KM increments (4 divisions)
        SliderTheme(
...
///
/// Extracted as a separate class to keep [_DistanceFilterBottomSheetState] focused.
