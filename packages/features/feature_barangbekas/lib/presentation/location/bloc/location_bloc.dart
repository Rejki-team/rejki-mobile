...
/// LocationBloc for feature_barangbekas — cascading location selection.
///
/// Separate type from feature_pekerjaan's LocationBloc so GetIt can register
/// a distinct factory for barangbekas without conflicting with other features.
