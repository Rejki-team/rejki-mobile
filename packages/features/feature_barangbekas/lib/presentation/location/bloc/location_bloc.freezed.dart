...
mixin _$LocationState {
 ...
 LocationLoadStatus get provincesStatus; LocationLoadStatus get regenciesStatus; LocationLoadStatus get districtsStatus; LocationLoadStatus get villagesStatus; List<LocationEntity> get provinces; List<LocationEntity> get regencies; List<LocationEntity> get districts; List<LocationEntity> get villages; LocationEntity? get selectedProvince; LocationEntity? get selectedRegency; LocationEntity? get selectedDistrict; LocationEntity? get selectedVillage; String? get errorMessage;
...
@useResult
$Res call({
 LocationLoadStatus provincesStatus, LocationLoadStatus regenciesStatus, LocationLoadStatus districtsStatus, LocationLoadStatus villagesStatus, List<LocationEntity> provinces, List<LocationEntity> regencies, List<LocationEntity> districts, List<LocationEntity> villages, LocationEntity? selectedProvince, LocationEntity? selectedRegency, LocationEntity? selectedDistrict, LocationEntity? selectedVillage, String? errorMessage
});
...
as List<LocationEntity>,selectedProvince: freezed == selectedProvince ? _self.selectedProvince : selectedProvince // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( LocationLoadStatus provincesStatus,  LocationLoadStatus regenciesStatus,  LocationLoadStatus districtsStatus,  LocationLoadStatus villagesStatus,  List<LocationEntity> provinces,  List<LocationEntity> regencies,  List<LocationEntity> districts,  List<LocationEntity> villages,  LocationEntity? selectedProvince,  LocationEntity? selectedRegency,  LocationEntity? selectedDistrict,  LocationEntity? selectedVillage,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LocationState() when $default != null:
return $default(_that.provincesStatus,_that.regenciesStatus,_that.districtsStatus,_that.villagesStatus,_that.provinces,_that.regencies,_that.districts,_that.villages,_that.selectedProvince,_that.selectedRegency,_that.selectedDistrict,_that.selectedVillage,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( LocationLoadStatus provincesStatus,  LocationLoadStatus regenciesStatus,  LocationLoadStatus districtsStatus,  LocationLoadStatus villagesStatus,  List<LocationEntity> provinces,  List<LocationEntity> regencies,  List<LocationEntity> districts,  List<LocationEntity> villages,  LocationEntity? selectedProvince,  LocationEntity? selectedRegency,  LocationEntity? selectedDistrict,  LocationEntity? selectedVillage,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _LocationState():
return $default(_that.provincesStatus,_that.regenciesStatus,_that.districtsStatus,_that.villagesStatus,_that.provinces,_that.regencies,_that.districts,_that.villages,_that.selectedProvince,_that.selectedRegency,_that.selectedDistrict,_that.selectedVillage,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( LocationLoadStatus provincesStatus,  LocationLoadStatus regenciesStatus,  LocationLoadStatus districtsStatus,  LocationLoadStatus villagesStatus,  List<LocationEntity> provinces,  List<LocationEntity> regencies,  List<LocationEntity> districts,  List<LocationEntity> villages,  LocationEntity? selectedProvince,  LocationEntity? selectedRegency,  LocationEntity? selectedDistrict,  LocationEntity? selectedVillage,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _LocationState() when $default != null:
return $default(_that.provincesStatus,_that.regenciesStatus,_that.districtsStatus,_that.villagesStatus,_that.provinces,_that.regencies,_that.districts,_that.villages,_that.selectedProvince,_that.selectedRegency,_that.selectedDistrict,_that.selectedVillage,_that.errorMessage);case _:
  return null;
...
class _LocationState extends LocationState {
  const _LocationState({this.provincesStatus = LocationLoadStatus.initial, this.regenciesStatus = LocationLoadStatus.initial, this.districtsStatus = LocationLoadStatus.initial, this.villagesStatus = LocationLoadStatus.initial, final  List<LocationEntity> provinces = const [], final  List<LocationEntity> regencies = const [], final  List<LocationEntity> districts = const [], final  List<LocationEntity> villages = const [], this.selectedProvince, this.selectedRegency, this.selectedDistrict, this.selectedVillage, this.errorMessage}): _provinces = provinces,_regencies = regencies,_districts = districts,_villages = villages,super._();
...
@override
int get hashCode => Object.hash(runtimeType,provincesStatus,regenciesStatus,districtsStatus,villagesStatus,const DeepCollectionEquality().hash(_provinces),const DeepCollectionEquality().hash(_regencies),const DeepCollectionEquality().hash(_districts),const DeepCollectionEquality().hash(_villages),selectedProvince,selectedRegency,selectedDistrict,selectedVillage,errorMessage);
