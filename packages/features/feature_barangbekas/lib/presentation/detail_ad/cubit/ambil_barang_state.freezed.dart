...
part of 'ambil_barang_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AmbilBarangState);
}
...
/// @nodoc
class $AmbilBarangStateCopyWith<$Res>  {
$AmbilBarangStateCopyWith(AmbilBarangState _, $Res Function(AmbilBarangState) __);
}


/// Adds pattern-matching-related methods to [AmbilBarangState].
extension AmbilBarangStatePatterns on AmbilBarangState {
...
class _Initial implements AmbilBarangState {
  const _Initial();
...
@override
String toString() {
  return 'AmbilBarangState.initial()';
}
...
class _Submitting implements AmbilBarangState {
  const _Submitting();
...
@override
String toString() {
  return 'AmbilBarangState.submitting()';
}
...
class _Success implements AmbilBarangState {
  const _Success();
...
@override
String toString() {
  return 'AmbilBarangState.success()';
}
...
class _Failure implements AmbilBarangState {
  const _Failure(this.message);
  

 final  String message;

/// Create a copy of AmbilBarangState
...
@override
String toString() {
  return 'AmbilBarangState.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $AmbilBarangStateCopyWith<$Res> {
