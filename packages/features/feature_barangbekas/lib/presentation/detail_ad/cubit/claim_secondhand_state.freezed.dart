...
part of 'claim_secondhand_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ClaimSecondhandState);
}
...
/// @nodoc
class $ClaimSecondhandStateCopyWith<$Res>  {
$ClaimSecondhandStateCopyWith(ClaimSecondhandState _, $Res Function(ClaimSecondhandState) __);
}


/// Adds pattern-matching-related methods to [ClaimSecondhandState].
extension ClaimSecondhandStatePatterns on ClaimSecondhandState {
...
class _Initial implements ClaimSecondhandState {
  const _Initial();
...
@override
String toString() {
  return 'ClaimSecondhandState.initial()';
}
...
class _Submitting implements ClaimSecondhandState {
  const _Submitting();
...
@override
String toString() {
  return 'ClaimSecondhandState.submitting()';
}
...
class _Success implements ClaimSecondhandState {
  const _Success();
...
@override
String toString() {
  return 'ClaimSecondhandState.success()';
}
...
class _Failure implements ClaimSecondhandState {
  const _Failure(this.message);
  

 final  String message;

/// Create a copy of ClaimSecondhandState
...
@override
String toString() {
  return 'ClaimSecondhandState.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $ClaimSecondhandStateCopyWith<$Res> {
