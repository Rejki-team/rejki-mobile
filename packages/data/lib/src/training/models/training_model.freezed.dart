...
@override
String toString() {
  return 'TrainingModel(id: $id, title: $title, description: $description, companyName: $companyName, locationAddress: $locationAddress, dateOfTraining: $dateOfTraining, feePerPerson: $feePerPerson, status: $status, userId: $userId, adCode: $adCode, email: $email, role: $role, images: $images, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String title, String description,@JsonKey(name: 'company_name') String companyName,@JsonKey(name: 'location_address') String locationAddress,@JsonKey(name: 'date_of_training') String dateOfTraining,@JsonKey(name: 'fee_per_person') int feePerPerson, String status,@JsonKey(name: 'user_id') String userId,@JsonKey(name: 'ad_code') String? adCode, String? email, String? role, List<TrainingImageModel> images,@JsonKey(name: 'created_at') DateTime? createdAt,@JsonKey(name: 'updated_at') DateTime? updatedAt
});
