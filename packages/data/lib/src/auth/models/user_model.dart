...
abstract class UserModel with _$UserModel {
  const factory UserModel({
    ...
    @JsonKey(name: 'working_hours_editable') @Default(true) bool workingHoursEditable,
    /// Flag baru dari API — apakah user diizinkan mengirim update jam kerja
    @JsonKey(name: 'can_update_working_hours') @Default(true) bool canUpdateWorkingHours,
    ...
    @JsonKey(name: 'phone_visible_editable') @Default(true) bool phoneVisibleEditable,
    /// Flag baru dari API — apakah user diizinkan mengirim update visibilitas telepon
    @JsonKey(name: 'can_update_phone_visibility') @Default(true) bool canUpdatePhoneVisibility,
