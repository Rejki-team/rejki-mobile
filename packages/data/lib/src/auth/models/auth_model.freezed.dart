...
@JsonKey(name: 'email_or_phone') String get emailOrPhone; String get password;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoginRequestModel&&(identical(other.emailOrPhone, emailOrPhone) || other.emailOrPhone == emailOrPhone)&&(identical(other.password, password) || other.password == password));
}
...
@override
String toString() {
  return 'LoginRequestModel(emailOrPhone: $emailOrPhone, password: $password)';
}
...
@useResult
$Res call({
@JsonKey(name: 'email_or_phone') String emailOrPhone, String password
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'email_or_phone')  String emailOrPhone,  String password)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginRequestModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'email_or_phone')  String emailOrPhone,  String password)  $default,) {final _that = this;
switch (_that) {
case _LoginRequestModel():
return $default(_that.emailOrPhone,_that.password);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'email_or_phone')  String emailOrPhone,  String password)?  $default,) {final _that = this;
switch (_that) {
case _LoginRequestModel() when $default != null:
return $default(_that.emailOrPhone,_that.password);case _:
  return null;
...
class _LoginRequestModel extends LoginRequestModel {
  const _LoginRequestModel({@JsonKey(name: 'email_or_phone') required this.emailOrPhone, required this.password}): super._();
  factory _LoginRequestModel.fromJson(Map<String, dynamic> json) => _$LoginRequestModelFromJson(json);

@override@JsonKey(name: 'email_or_phone') final  String emailOrPhone;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoginRequestModel&&(identical(other.emailOrPhone, emailOrPhone) || other.emailOrPhone == emailOrPhone)&&(identical(other.password, password) || other.password == password));
}
