...
@override
String toString() {
  return 'UserModel(id: $id, email: $email, phoneNumber: $phoneNumber, workingHours: $workingHours, verificationStatus: $verificationStatus, isPreviewCredential: $isPreviewCredential, role: $role, status: $status, createdAt: $createdAt, updatedAt: $updatedAt, userInfo: $userInfo)';
}
