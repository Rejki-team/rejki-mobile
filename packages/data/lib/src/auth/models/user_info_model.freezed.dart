...
mixin _$UserInfoModel {
 ...
 String get id;@JsonKey(name: 'user_id') String get userId;@JsonKey(name: 'full_name') String get fullName; String get nik; String get gender; String get dob; String get province; String get city; String get districts; String get village;@JsonKey(name: 'rt_rw') String get rtRw;@JsonKey(name: 'ktp_file_path') String get ktpFilePath;@JsonKey(name: 'created_at') String get createdAt;@JsonKey(name: 'updated_at') String get updatedAt;
...
@override
String toString() {
  return 'UserInfoModel(id: $id, userId: $userId, fullName: $fullName, nik: $nik, gender: $gender, dob: $dob, province: $province, city: $city, districts: $districts, village: $village, rtRw: $rtRw, ktpFilePath: $ktpFilePath, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'user_id') String userId,@JsonKey(name: 'full_name') String fullName, String nik, String gender, String dob, String province, String city, String districts, String village,@JsonKey(name: 'rt_rw') String rtRw,@JsonKey(name: 'ktp_file_path') String ktpFilePath,@JsonKey(name: 'created_at') String createdAt,@JsonKey(name: 'updated_at') String updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId, @JsonKey(name: 'full_name')  String fullName,  String nik,  String gender,  String dob,  String province,  String city,  String districts,  String village, @JsonKey(name: 'rt_rw')  String rtRw, @JsonKey(name: 'ktp_file_path')  String ktpFilePath, @JsonKey(name: 'created_at')  String createdAt, @JsonKey(name: 'updated_at')  String updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserInfoModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId, @JsonKey(name: 'full_name')  String fullName,  String nik,  String gender,  String dob,  String province,  String city,  String districts,  String village, @JsonKey(name: 'rt_rw')  String rtRw, @JsonKey(name: 'ktp_file_path')  String ktpFilePath, @JsonKey(name: 'created_at')  String createdAt, @JsonKey(name: 'updated_at')  String updatedAt)  $default,) {final _that = this;
switch (_that) {
case _UserInfoModel():
return $default(_that.id,_that.userId,_that.fullName,_that.nik,_that.gender,_that.dob,_that.province,_that.city,_that.districts,_that.village,_that.rtRw,_that.ktpFilePath,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'user_id')  String userId, @JsonKey(name: 'full_name')  String fullName,  String nik,  String gender,  String dob,  String province,  String city,  String districts,  String village, @JsonKey(name: 'rt_rw')  String rtRw, @JsonKey(name: 'ktp_file_path')  String ktpFilePath, @JsonKey(name: 'created_at')  String createdAt, @JsonKey(name: 'updated_at')  String updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _UserInfoModel() when $default != null:
return $default(_that.id,_that.userId,_that.fullName,_that.nik,_that.gender,_that.dob,_that.province,_that.city,_that.districts,_that.village,_that.rtRw,_that.ktpFilePath,_that.createdAt,_that.updatedAt);case _:
  return null;
