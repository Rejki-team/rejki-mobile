...
/// Success status
 ...
 String get message;/// List of location data
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LocationResponseModel&&(identical(other.success, success) || other.success == success)&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other.data, data));
}
...
@override
String toString() {
  return 'LocationResponseModel(success: $success, message: $message, data: $data)';
}
...
@useResult
$Res call({
 bool success, String message, List<LocationModel> data
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool success,  String message,  List<LocationModel> data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LocationResponseModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool success,  String message,  List<LocationModel> data)  $default,) {final _that = this;
switch (_that) {
case _LocationResponseModel():
return $default(_that.success,_that.message,_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool success,  String message,  List<LocationModel> data)?  $default,) {final _that = this;
switch (_that) {
case _LocationResponseModel() when $default != null:
return $default(_that.success,_that.message,_that.data);case _:
  return null;
...
class _LocationResponseModel extends LocationResponseModel {
  const _LocationResponseModel({required this.success, required this.message, required final  List<LocationModel> data}): _data = data,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LocationResponseModel&&(identical(other.success, success) || other.success == success)&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other._data, _data));
}
