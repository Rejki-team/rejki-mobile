...
mixin _$WorkerEntity {
 ...
 String get id; String get name; String get adCode;/// Pemilik iklan (`poster_id` backend) — dipakai fetch agregat rating
/// (F-17, PRD §5.15). `null` bila backend belum mengirimkannya.
 String? get posterId; int get age; double get rating; int get reviewCount; int get wage; String? get statusLabel; String? get avatarUrl; bool get isAd; String? get adTitle; String? get adImageUrl;// New fields for Detail Worker API
...
@override
int get hashCode => Object.hashAll([runtimeType,id,name,adCode,posterId,age,rating,reviewCount,wage,statusLabel,avatarUrl,isAd,adTitle,adImageUrl,education,available,isNegotiable,phoneNumber,workExperience,address,latitude,longitude]);

@override
String toString() {
  return 'WorkerEntity(id: $id, name: $name, adCode: $adCode, posterId: $posterId, age: $age, rating: $rating, reviewCount: $reviewCount, wage: $wage, statusLabel: $statusLabel, avatarUrl: $avatarUrl, isAd: $isAd, adTitle: $adTitle, adImageUrl: $adImageUrl, education: $education, available: $available, isNegotiable: $isNegotiable, phoneNumber: $phoneNumber, workExperience: $workExperience, address: $address, latitude: $latitude, longitude: $longitude)';
}
...
@useResult
$Res call({
 String id, String name, String adCode, String? posterId, int age, double rating, int reviewCount, int wage, String? statusLabel, String? avatarUrl, bool isAd, String? adTitle, String? adImageUrl, String? education, String? available, bool? isNegotiable, String? phoneNumber, String? workExperience, String? address, double? latitude, double? longitude
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String adCode,  String? posterId,  int age,  double rating,  int reviewCount,  int wage,  String? statusLabel,  String? avatarUrl,  bool isAd,  String? adTitle,  String? adImageUrl,  String? education,  String? available,  bool? isNegotiable,  String? phoneNumber,  String? workExperience,  String? address,  double? latitude,  double? longitude)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WorkerEntity() when $default != null:
return $default(_that.id,_that.name,_that.adCode,_that.posterId,_that.age,_that.rating,_that.reviewCount,_that.wage,_that.statusLabel,_that.avatarUrl,_that.isAd,_that.adTitle,_that.adImageUrl,_that.education,_that.available,_that.isNegotiable,_that.phoneNumber,_that.workExperience,_that.address,_that.latitude,_that.longitude);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String adCode,  String? posterId,  int age,  double rating,  int reviewCount,  int wage,  String? statusLabel,  String? avatarUrl,  bool isAd,  String? adTitle,  String? adImageUrl,  String? education,  String? available,  bool? isNegotiable,  String? phoneNumber,  String? workExperience,  String? address,  double? latitude,  double? longitude)  $default,) {final _that = this;
switch (_that) {
case _WorkerEntity():
return $default(_that.id,_that.name,_that.adCode,_that.posterId,_that.age,_that.rating,_that.reviewCount,_that.wage,_that.statusLabel,_that.avatarUrl,_that.isAd,_that.adTitle,_that.adImageUrl,_that.education,_that.available,_that.isNegotiable,_that.phoneNumber,_that.workExperience,_that.address,_that.latitude,_that.longitude);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String adCode,  String? posterId,  int age,  double rating,  int reviewCount,  int wage,  String? statusLabel,  String? avatarUrl,  bool isAd,  String? adTitle,  String? adImageUrl,  String? education,  String? available,  bool? isNegotiable,  String? phoneNumber,  String? workExperience,  String? address,  double? latitude,  double? longitude)?  $default,) {final _that = this;
switch (_that) {
case _WorkerEntity() when $default != null:
return $default(_that.id,_that.name,_that.adCode,_that.posterId,_that.age,_that.rating,_that.reviewCount,_that.wage,_that.statusLabel,_that.avatarUrl,_that.isAd,_that.adTitle,_that.adImageUrl,_that.education,_that.available,_that.isNegotiable,_that.phoneNumber,_that.workExperience,_that.address,_that.latitude,_that.longitude);case _:
  return null;
...
class _WorkerEntity implements WorkerEntity {
  const _WorkerEntity({required this.id, required this.name, required this.adCode, this.posterId, required this.age, required this.rating, required this.reviewCount, required this.wage, this.statusLabel, this.avatarUrl, this.isAd = false, this.adTitle, this.adImageUrl, this.education, this.available, this.isNegotiable, this.phoneNumber, this.workExperience, this.address, this.latitude, this.longitude});
...
/// Create a copy of WorkerEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? adCode = null,Object? posterId = freezed,Object? age = null,Object? rating = null,Object? reviewCount = null,Object? wage = null,Object? statusLabel = freezed,Object? avatarUrl = freezed,Object? isAd = null,Object? adTitle = freezed,Object? adImageUrl = freezed,Object? education = freezed,Object? available = freezed,Object? isNegotiable = freezed,Object? phoneNumber = freezed,Object? workExperience = freezed,Object? address = freezed,Object? latitude = freezed,Object? longitude = freezed,}) {
