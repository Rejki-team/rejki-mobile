...
mixin _$UserInfoEntity {
 ...
 String get phoneNumber; String get educationLevel; String get educationFocus; String get workExperience; String get addressKtp; String get country;/// Koordinat hasil geocoding alamat terdaftar (F-1) — dipakai filter radius
...
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,fullName,nik,gender,dob,province,city,districts,village,rtRw,ktpFilePath,createdAt,updatedAt,phoneNumber,educationLevel,educationFocus,workExperience,addressKtp,country,latitude,longitude]);
