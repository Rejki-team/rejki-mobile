...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TrainingFailure);
}
...
/// @nodoc
class $TrainingFailureCopyWith<$Res>  {
$TrainingFailureCopyWith(TrainingFailure _, $Res Function(TrainingFailure) __);
}


/// Adds pattern-matching-related methods to [TrainingFailure].
extension TrainingFailurePatterns on TrainingFailure {
...
class _ServerError extends TrainingFailure {
  const _ServerError([this.message]): super._();
  

 final  String? message;

/// Create a copy of TrainingFailure
...
@override
String toString() {
  return 'TrainingFailure.serverError(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ServerErrorCopyWith<$Res> implements $TrainingFailureCopyWith<$Res> {
...
class _NetworkError extends TrainingFailure {
...
@override
String toString() {
  return 'TrainingFailure.networkError()';
}
...
class _Unauthorized extends TrainingFailure {
...
@override
String toString() {
  return 'TrainingFailure.unauthorized()';
}
...
class _NotFound extends TrainingFailure {
...
@override
String toString() {
  return 'TrainingFailure.notFound()';
}
...
class _Unknown extends TrainingFailure {
...
@override
String toString() {
  return 'TrainingFailure.unknown()';
}
