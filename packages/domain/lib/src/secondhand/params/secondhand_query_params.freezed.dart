...
mixin _$SecondhandQueryParams {
 ...
 int get page; int get limit;/// Koordinat pusat filter radius (F-1) — `null` = tidak difilter.
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SecondhandQueryParams&&(identical(other.page, page) || other.page == page)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.longitude, longitude) || other.longitude == longitude));
}


@override
int get hashCode => Object.hash(runtimeType,page,limit,latitude,longitude);

@override
String toString() {
  return 'SecondhandQueryParams(page: $page, limit: $limit, latitude: $latitude, longitude: $longitude)';
}
...
@useResult
$Res call({
 int page, int limit, double? latitude, double? longitude
});
...
/// Create a copy of SecondhandQueryParams
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? page = null,Object? limit = null,Object? latitude = freezed,Object? longitude = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int page,  int limit,  double? latitude,  double? longitude)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SecondhandQueryParams() when $default != null:
return $default(_that.page,_that.limit,_that.latitude,_that.longitude);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int page,  int limit,  double? latitude,  double? longitude)  $default,) {final _that = this;
switch (_that) {
case _SecondhandQueryParams():
return $default(_that.page,_that.limit,_that.latitude,_that.longitude);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int page,  int limit,  double? latitude,  double? longitude)?  $default,) {final _that = this;
switch (_that) {
case _SecondhandQueryParams() when $default != null:
return $default(_that.page,_that.limit,_that.latitude,_that.longitude);case _:
  return null;
...
class _SecondhandQueryParams implements SecondhandQueryParams {
  const _SecondhandQueryParams({this.page = 1, this.limit = 10, this.latitude, this.longitude});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SecondhandQueryParams&&(identical(other.page, page) || other.page == page)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.longitude, longitude) || other.longitude == longitude));
}
...
/// Create a copy of SecondhandQueryParams
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? page = null,Object? limit = null,Object? latitude = freezed,Object? longitude = freezed,}) {
