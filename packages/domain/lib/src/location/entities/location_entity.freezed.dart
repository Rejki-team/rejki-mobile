...
/// Unique location identifier
 String get id;/// Location name (e.g., "JAWA BARAT", "KAB. BOGOR")
 String get name;/// Latitude coordinate
...
class _LocationEntity extends LocationEntity {
  const _LocationEntity({required this.id, required this.name, this.latitude, this.longitude}): super._();
