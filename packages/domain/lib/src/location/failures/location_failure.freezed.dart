...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LocationFailure);
}
...
/// @nodoc
class $LocationFailureCopyWith<$Res>  {
$LocationFailureCopyWith(LocationFailure _, $Res Function(LocationFailure) __);
}


/// Adds pattern-matching-related methods to [LocationFailure].
extension LocationFailurePatterns on LocationFailure {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String? errorMessage)?  serverError,TResult Function()?  networkError,TResult Function()?  unauthorized,TResult Function()?  notFound,TResult Function()?  unknown,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ServerError() when serverError != null:
return serverError(_that.errorMessage);case _NetworkError() when networkError != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String? errorMessage)  serverError,required TResult Function()  networkError,required TResult Function()  unauthorized,required TResult Function()  notFound,required TResult Function()  unknown,}) {final _that = this;
switch (_that) {
case _ServerError():
return serverError(_that.errorMessage);case _NetworkError():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String? errorMessage)?  serverError,TResult? Function()?  networkError,TResult? Function()?  unauthorized,TResult? Function()?  notFound,TResult? Function()?  unknown,}) {final _that = this;
switch (_that) {
case _ServerError() when serverError != null:
return serverError(_that.errorMessage);case _NetworkError() when networkError != null:
return networkError();case _Unauthorized() when unauthorized != null:
...
class _ServerError extends LocationFailure {
  const _ServerError([this.errorMessage]): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ServerError&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}
...
@override
String toString() {
  return 'LocationFailure.serverError(errorMessage: $errorMessage)';
}
...
/// @nodoc
abstract mixin class _$ServerErrorCopyWith<$Res> implements $LocationFailureCopyWith<$Res> {
...
class _NetworkError extends LocationFailure {
...
@override
String toString() {
  return 'LocationFailure.networkError()';
}
...
class _Unauthorized extends LocationFailure {
...
@override
String toString() {
  return 'LocationFailure.unauthorized()';
}
...
class _NotFound extends LocationFailure {
...
@override
String toString() {
  return 'LocationFailure.notFound()';
}
...
class _Unknown extends LocationFailure {
